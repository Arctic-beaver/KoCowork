...
namespace CoCowork.UI.ViewModels
{
    ...
    {
        private ObservableCollection<BookingViewModel> _workplaces;
        public ObservableCollection<BookingViewModel> Workplaces
        {
            get => _workplaces;
            set
            {
        ...
        public BookingViewModel()
        {
            ...
            //Workplaces = new ObservableCollection<WorkplaceViewModel>();
            //var places = new PlaceViewModel();
            //Workplaces.Add(places.GetPlaces());
        }
    }
}
